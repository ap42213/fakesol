          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <a href="https://github.com/ap42213/fakesol" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-zinc-500 hover:text-white transition-colors">
